 ...
 * Tham số: index: Chỉ số độc giả cần in.*/
 ...
 * Tham số: code: Mã thẻ cần tra cứu.
 * Giá trị trả về: Chỉ số độc giả hoặc -1 nếu không tìm thấy.*/
 ...
 * Tham số: idcard: Số CMND cần tra cứu.
 * Giá trị trả về: Chỉ số độc giả hoặc -1 nếu không tìm thấy. */
 ...
 * Tham số: start_index: Vị trí bắt đầu dịch.*/
