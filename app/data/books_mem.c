 ...
 * Tham số: index: Chỉ số sách cần lấy.
 * Giá trị trả về: Con trỏ tới tiêu đề.*/
 ...
 * Tham số: index: Chỉ số sách cần lấy.
 * Giá trị trả về: Con trỏ tới tên tác giả.*/
 ...
 * Tham số: index: Chỉ số sách cần lấy.
 * Giá trị trả về: Con trỏ tới tên nhà xuất bản.*/
 ...
 * Tham số: index: Chỉ số sách cần lấy.
 * Giá trị trả về: Con trỏ tới thể loại. */
