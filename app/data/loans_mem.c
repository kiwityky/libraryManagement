 ...
 * Tham số: index: Chỉ số phiếu mượn.
 ...
 * Giá trị trả về: Con trỏ tới mảng đếm số sách. */
 ...
 * Giá trị trả về: Vị trí phần tử trong mảng phẳng.*/
 ...
 *   - loan_index: Chỉ số phiếu mượn.
 *   - book_index: Thứ tự sách trong phiếu.
 * Giá trị trả về: Con trỏ tới chuỗi ISBN.*/
