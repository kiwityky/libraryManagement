 ...
 *   - year: Năm ban đầu (>=0).
 * Giá trị trả về: Tổng số ngày tính từ mốc 0 theo lịch 30 ngày/tháng. */
 ...
 * Giá trị trả về: -1 nếu ngày thứ nhất sớm hơn, 1 nếu muộn hơn, 0 nếu trùng nhau.*/
 ...
 * Giá trị trả về: Hiệu số ngày (có thể âm) giữa hai mốc. */
